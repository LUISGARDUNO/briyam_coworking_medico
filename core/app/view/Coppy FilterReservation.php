...
<form class="form-horizontal" role="form" id="newquickreservationform">
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" name="title" id="title" class="form-control" id="inputEmail1" placeholder="Asunto">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Paciente</label>
    <div class="col-lg-10">
<select name="pacient_id" id="pacient_id" class="form-control">
...
<option value="">-- SELECCIONE --</option>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      <input type="date" name="date_at" id="date_at" class="pickadate form-control" id="inputEmail1" placeholder="Fecha">
    </div>
    <div class="col-lg-5">
      <input type="time" name="time_at" id="time_at" class="pickatime form-control" id="inputEmail1" placeholder="Hora">
    </div>
  </div>
    <div class="form-group">
...
<div class="input-group">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-primary btn-block">Agregar Reserva</button>
    </div>
  </div>
</form>
      </div>
